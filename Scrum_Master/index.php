...
<header>
	...
	<div class="flex-container">
		<div class="flex-slide home">
			<div class="flex-title flex-title-home">Afficher les equipes</div>
		...
		<div class="flex-slide work">
			<div class="flex-affect" style="color: antiquewhite;">Afficter des projets a des equipes</div>
			<div class="flex-about">
				<form class="contact-form">
				<br>
					<p>Id_Projet <input type="text" name="email"></p>
					<p>Id_equipe <textarea type="text" name="comment" row="5"></textarea></p>
					<p><input type="submit" name="email" value="Afficter"></p>
				</form>
			</div>
		</div>
		<div class="flex-slide about">
			<div class="flex-title">aficher les membres</div>
